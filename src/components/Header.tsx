...
export default function Header({
  ...
  const tickerStrip = Object.values(stockPrices).sort(
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <h1
            className={`text-2xl font-bold ${
              darkMode ? "text-white" : "text-darkSlateBlue"
            }`}
          >
        ...
        <div className="mt-4">
                    ...
                    <span
                      className={`px-2 py-1 rounded-md text-xs font-semibold ${
                        darkMode
                          ...
                          : "bg-gray-200 text-darkSlateBlue"
                      }`}
                    >
                      {stock?.ticker}
                    </span>
          ...
          <div className="lg:hidden">
            <button
              ...
              className={`w-full justify-between flex items-center px-4 py-2 rounded-md border ${
                darkMode
                  ? "border-gray-700 text-gray-100 bg-gray-800 hover:bg-gray-700"
